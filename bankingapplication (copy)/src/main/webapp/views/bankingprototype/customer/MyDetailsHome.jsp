...
<%BankInterface bInterface=new BankLogical(); 
	...
	<h1 style="margin-top:30px;color:#243b55;text-transform:uppercase;">WELCOME <%=name %></h1>
	<hr class="new5">
		<li>
			<form action="<%=request.getContextPath() %>/CustomerHomePage" target="_parent">
			<i class='fas fa-house-user' style='color:black;'><input type="submit" value="Home" class="dropbtn"></i>
			</form>
...
<input type="submit" value="Logout" class="top">
		...
		<menu style="position: fixed; left: 550px;top:45px;" >
			...
			<form action="<%=request.getContextPath()%>/SetRequestAccountStatus"
				...
				<i class='fas fa-landmark' style='color:black;'><input type="submit" value="Request" class="dropbtn" /></i>
			</form>
		</li>
		
		<li><div class="dropdown">
			<i class='fas fa-dollar-sign' style='font:size:20px;color:black;'>	<button class="dropbtn">Transaction</button></i>
