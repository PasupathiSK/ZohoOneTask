...
<body>
	...
	<h1 style="position:fixed;left:10px;font-size:60px;top:25px;color:#DB7093;"><i class='fas fa-landmark m-2'> BLINK BANK</i></h1>
...
<li>
	...
	<iframe src="views/bankingprototype/admin/Admin.jsp" name="admin"
		height="100%"
		style="position: fixed; left: 15%; width: 85%; top: 120px; border: none;background-color:#000a2008;"></iframe>
</body>
</html>