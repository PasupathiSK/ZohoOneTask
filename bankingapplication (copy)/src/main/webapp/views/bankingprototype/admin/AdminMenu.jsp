...
<body>
	...
	<ul class="topnav">
	<h1 style="margin-top:30px;color: #243b55;">WELCOME ADMIN</h1>
	<hr class="new5">
		<li>
			<form action="<%=request.getContextPath()%>/AdminHomePage"
				method="post" target="_parent">
				<i class='fas fa-home' ><input type="submit" value="Home" class="dropbtn" /></i>
			</form>
		</li>
		<li>
			<form action="<%=request.getContextPath()%>/UserInfoByIdPage"
				method="post" target="admin">
				<i class='fas fa-users' style="color:black;"><input type="submit" value="User Info" class="dropbtn" /></i>
			</form>
		</li>
		<li>
			<form
				...
				method="post" target="admin">
				<i class='fas fa-receipt drpcnt' style="color:black;"><input type="submit" value="Statement" class="dropbtn" /></i>
			</form>
		</li>
		<li>
			<form action="<%=request.getContextPath()%>/AllAccountInfoPage"
				method="post" target="admin">
				<i class='far fa-address-book' style="color:black;"><input type="submit" value="Account Info" class="dropbtn" /></i>
			</form>
		</li>
	<!-- 	<li>
		...
		<li>
			...
			<form action="<%=request.getContextPath()%>/BlockAccountPage"
				method="post" target="admin">
				 <i class='fas fa-exclamation-triangle' style="color:black;"><input type="submit" value="Block Account" class="dropbtn" /></i>
			</form>
		</li>
		<li>
			<form
				...
				method="post" target="admin">
				<i class='fas fa-user-lock' style="color:black;"><input type="submit" value="Bolck Customer" class="dropbtn" /></i>
			</form>
		</li>
		<li>
	<div class="dropdown">
				<i class='fas fa-user-plus'> <i style="font-size:30px;padding:0px 5px;">Add User</i></i>
